...
**[12-roman_to_int.py](12-roman_to_int.py)** - Create a function `def roman_to_int(roman_string):` that converts a [Roman numeral](https://alx-intranet.hbtn.io/rltoken/oSuwqUrL0BL_hi4VqVvs_g) to an integer.
...
```
ulien@ubuntu:~/CPython$ python3 --version
Python 3.4.3
